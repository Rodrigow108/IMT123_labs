...
HD_PWD='C:/Users/ANDRES ESCOBAR/Documents/5to Semestre/Circuitos Digitales/Laboratorios/project_lab4_Deco1/project_Multi_4bit_Lab5/project_Multi_4bit_Lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mod_add_4BIT_ds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mod_add_4BIT_ds.tcl
