...
HD_PWD='C:/Users/ANDRES ESCOBAR/project_lab10_Contador_Gray/project_lab10_Contador_Gray.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab10_ds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab10_ds.tcl
