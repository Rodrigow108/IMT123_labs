...
HD_PWD='C:/Users/ANDRES ESCOBAR/project_lab10_Contador_Gray/project_lab10_Contador_Gray.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab10_ds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab10_ds.tcl -notrace
