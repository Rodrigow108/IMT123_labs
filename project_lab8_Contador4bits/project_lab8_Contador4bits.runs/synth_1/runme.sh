...
HD_PWD='C:/Users/ANDRES ESCOBAR/project_lab8_Contador4bits/project_lab8_Contador4bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab8_ds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab8_ds.tcl
