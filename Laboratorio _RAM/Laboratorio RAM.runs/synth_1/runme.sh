...
HD_PWD='C:/Users/hp/Documents/GitHub/IMT123_Labs/Laboratorio RAM/Laboratorio RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Module_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Module_register.tcl
