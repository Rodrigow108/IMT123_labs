...
HD_PWD='C:/Users/hp/Documents/GitHub/IMT123_Labs/Laboratorio RAM/Laboratorio RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Module_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Module_register.tcl -notrace
