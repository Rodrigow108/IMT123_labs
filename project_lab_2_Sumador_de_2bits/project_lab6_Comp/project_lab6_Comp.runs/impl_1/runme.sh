...
HD_PWD='C:/Users/ANDRES ESCOBAR/Documents/5to Semestre/Circuitos Digitales/Laboratorios/Lab_2 2/project_lab6_Comp/project_lab6_Comp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_ds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comp_ds.tcl -notrace
