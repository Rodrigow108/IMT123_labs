...
HD_PWD='C:/Users/ANDRES ESCOBAR/Documents/5to Semestre/Circuitos Digitales/Laboratorios/Lab_2 2/project_lab6_Comp/project_lab6_Comp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_ds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comp_ds.tcl
