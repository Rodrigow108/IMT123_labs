...
HD_PWD='C:/Users/ANDRES ESCOBAR/Documents/5to Semestre/Circuitos Digitales/Laboratorios/Lab_2 2/Lab_2 2/Lab_2 2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_2_DS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_2_DS.tcl -notrace
