...
HD_PWD='C:/Users/ANDRES ESCOBAR/Documents/5to Semestre/Circuitos Digitales/Laboratorios/Lab_2 2/Lab_2 2/Lab_2 2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_2_DS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_2_DS.tcl
